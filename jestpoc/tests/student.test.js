...
describe('Students Functional testing', () => {
    ...
    */
    xit('if student list is empty', async () => {
        ...
        .get('/api/v1/students')
        .set('Accept', 'application/json')
        .set('authtoken', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDRlMDRkODA4M2FjZjI3YWU1Y2JhZWYiLCJpYXQiOjE2MTU4OTIxMjd9.ywm5pBYi2_eCkvFSDWk4t3t6NFheVg_rOFh5dKlI7eY')
        .expect('Content-Type', /json/)
        .expect(200)
    ...
    */
    xit('student Add test cases', async () => {
        try{
            ...
            expect('liji123@gmail.com').toBe(data.data.email);
        }catch(err){
            console.log(err)
        }
    })
    ...
    */
    xit('student Add test cases', async () => {
        try{
            ...
            .set('Accept', 'application/json')
            .set('authtoken', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDRlMDRkODA4M2FjZjI3YWU1Y2JhZWYiLCJpYXQiOjE2MTU4OTQxODJ9.GijNWhG6h6VXYR1-OclAsllraicg2WpuZst4GsGfmE0')
            .expect(403)
        }catch(err){
            console.log(err)
        }
    ...
    */
    xit('student Update test cases', async () => {
        try{
            ...
            .send({
               name: 'john Thomas3232323',
            })
            .set('Accept', 'application/json')
            .set('auth-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDRlMDRkODA4M2FjZjI3YWU1Y2JhZWYiLCJpYXQiOjE2MTU4OTQxODJ9.GijNWhG6h6VXYR1-OclAsllraicg2WpuZst4GsGfmE0')
            // .expect('Content-Type', /json/)
            .expect(200)
...
console.log(data.data)
    ...
    * Case 3: validate data nModified to be 1
    */
    it('student Delete test cases', async () => {
        try{
            const res = await request(app)
            .delete('/api/v1/delete-student/605079370513342c6bb977a9')
            .set('Accept', 'application/json')
            .set('auth-token', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MDRlMDRkODA4M2FjZjI3YWU1Y2JhZWYiLCJpYXQiOjE2MTU4OTQxODJ9.GijNWhG6h6VXYR1-OclAsllraicg2WpuZst4GsGfmE0')
            // .expect('Content-Type', /json/)
            .expect(200)
